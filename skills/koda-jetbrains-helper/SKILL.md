...
description: "Справочный навык по средам разработки компании JetBrains и производным от него продуктам (GIGAIDE, OpenIDE). Примени навык, чтобы помочь пользователю в использовании и настройке среды разработки (IDE), если у него возникает такой вопрос или проблема."
license: MIT
metadata:
  author: koda
  version: "1.0.0"
...
Проприетарная IDE от российских разработчиков Сбер на базе JetBrains IDEA.
...
IDE от российских разработчиков с открытым исходным кодом на базе JetBrains IDEA.
...
* **Сайт**: <https://gitverse.ru/features/gigaide/>
* **Репозиторий**: <https://gitflic.ru/project/openide/openide>
* **Документация**:
    * <https://gitflic.ru/project/openide/openide/docs>
    * <https://gitflic.ru/project/openide/openide/wiki>
    * основная документация JetBrains IDEA
* **Реестр изменений**: <https://gitflic.ru/project/openide/openide/issue>
* **Каталог плагинов**: <https://marketplace.openide.ru>
* **Реестр задач**: <https://gitflic.ru/project/openide/openide/issue?page=0>
